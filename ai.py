...
class AI:
    ...
    def format_question(self, question, app):
        ...
        # 排除否定式提问
        for v in (["不是", "是"], ["不会", "会"], ["不与", "与"], ["不能", "可以"], ["不同", "相同"], ["不用", "必须"], ["不对", "正确"], ["不宜", "适宜"], ["不曾", "曾经"], ["不可能", "可能"], ["不需要", "需要"], ["不包括", "包括"], ["不属于", "属于"], ["不正确", "正确"], ["不准确", "准确"], ["不相符", "相符"], ["不提供", "提供"], ["不位于", "位于"], ["不作为", "作为"], ["没有", "有"], ["未在", "在"], ["未曾", "曾经"], ["未获得", "获得"], ["是错", "是对"], ["无关", "有关"], ["并非", "是"]):
            if v[0] in question:
