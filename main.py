...
if __name__ == "__main__":
    ...
    print("-" * 72)
    print("{0}  _____  _____  _______   ____   _    _  ______  _____    ____  \n{0} / ____||_   _||__   __| / __ \\ | |  | ||  ____||  __ \\  / __ \\ \n{0}| |  __   | |     | |   | |  | || |__| || |__   | |__| || |  | |\n{0}| | |_ |  | |     | |   | |  | ||  __  ||  __|  |  _  / | |  | |\n{0}| |__| | _| |_    | |   | |__| || |  | || |____ | | \\ \\ | |__| |\n{0} \\_____||_____|   |_|    \\____/ |_|  |_||______||_|  \\_\\ \\____/\n".format(" " * 4))
    print("{}百万英雄答题助手".format(" " * 28))
    print("{}1.5.8.20180202".format(" " * 29))
    print("-" * 72)
